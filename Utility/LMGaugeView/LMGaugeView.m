...
#define kDefaultValueFont                       [UIFont fontWithName:@"Roboto-Light" size:12]
#define kDefaultFont                            [UIFont fontWithName:@"Roboto-Light" size:10]

#define kDefaultValueTextColor                  [UIColor colorWithRed:242.0/255 green:140.0/255 blue:11.0/255 alpha:1]

#define kDefaultUnitOfMeasurement               @"0/0 kW"
#define kDefaultUnitOfMeasurementFont           [UIFont fontWithName:@"Roboto-Regular" size:20]
#define kDefaultUnitOfMeasurementTextColor      [UIColor colorWithRed:128.0/255 green:128.0/255 blue:128.0/255 alpha:1]
...
//    CGContextStrokePath(context);
    ...
    if (!self.gradientLayer)
    {
        ...
        self.gradientLayer.frame = self.progressLayer.frame;
        self.gradientLayer.colors = [NSArray arrayWithObjects:(id)[[UIColor appGreenColor] CGColor],(id)[[UIColor appGreenColor] CGColor], (id)[[UIColor appOrangeColor] CGColor], (id)[[UIColor appRedColor] CGColor], (id)[[UIColor appRedColor] CGColor], nil];
...
//        self.valueLabel.text = [NSString stringWithFormat:@"$ %0.f\nPER DAY",self.value];
        ...
        self.valueLabel.textColor = [UIColor colorWithRed:242.0/255 green:141.0/255 blue:11.0/255 alpha:1.0];
        [self addSubview:self.valueLabel];
    }
    CGFloat insetX = self.ringThickness + self.divisionsPadding * 3 + self.divisionsRadius;
    CGRect frame1 = CGRectInset(self.progressLayer.frame, 70, insetX);
    CGRect frame2 = CGRectInset(self.progressLayer.frame, 70, insetX);

    if (WIN_WIDTH == 320) {
        self.valueLabel.frame = frame2;
    }else{
        self.valueLabel.frame = frame1;
    }
    self.valueLabel.numberOfLines = 2;
...
//    self.valueLabel.frame = CGRectOffset(self.valueLabel.frame, 0, self.showUnitOfMeasurement ? -self.divisionsPadding/2 : 0);
    ...
    if (!self.unitOfMeasurementLabel)
    {
        ...
        self.unitOfMeasurementLabel.numberOfLines = 2;
        ...
        self.unitOfMeasurementLabel.frame = CGRectMake(self.valueLabel.frame.origin.x,
                                                   self.valueLabel.frame.origin.y + 5 + CGRectGetHeight(self.valueLabel.frame)+10,
...
-(void)setCustomValueText: (NSString*)string {
