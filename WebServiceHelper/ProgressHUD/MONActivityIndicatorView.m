...
- (void)setupDefaults {
  ...
  self.delay = 0.1;
  self.duration = 0.3;
// self.defaultColor = [UIColor colorWithRed:219.0/255.0 green:183.0/255.0 blue:63.0/255.0 alpha:1.0];
    //self.defaultColor = [UIColor colorWithRed:46.0/255.0 green:149.0/255.0 blue:185.0/255.0 alpha:1.0];
  self.defaultColor = [UIColor colorWithRed:101/255.0 green:223/255.0 blue:231/255.0 alpha:1.0];
}
