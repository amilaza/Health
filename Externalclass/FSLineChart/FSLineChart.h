...
//@property (nonatomic) int gridStep; //not used
@property (nonatomic) int verticalGridStep;
@property (nonatomic) int horizontalGridStep;
@property (nonatomic) CGFloat maxBound;
@property (nonatomic) CGFloat minBound;
// Margin of the chart
...
@property (nonatomic, strong) UIColor* fillColorOne;
@property (nonatomic, strong) UIColor* fillColorTwo;
